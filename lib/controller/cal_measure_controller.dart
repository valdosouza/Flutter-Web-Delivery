...
part 'cal_measure_controller.g.dart';

class CalMeasureController = _CalMeasureController with _$CalMeasureController;

abstract class _CalMeasureController with Store {
