...
part 'cal_dough_controller.g.dart';

class CalDoughController = _CalDoughController with _$CalDoughController;

abstract class _CalDoughController with Store {
  final String _baseUrl = '${Constants.BASE_API_URL}/restDough/getlist/';
