...
class OrderPaymentController = _OrderPaymentController
    with _$OrderPaymentController;

abstract class _OrderPaymentController with Store {
  final String _baseUrl = '${Constants.BASE_API_URL}/payment/getlist';
  ...
  @observable
  ObservableFuture<List<PaymentTypeModel>> postsListFuture;
