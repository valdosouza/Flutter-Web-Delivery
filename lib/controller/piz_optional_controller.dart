...
part 'piz_optional_controller.g.dart';

class PizOptionalController = _PizOptionalController
    with _$PizOptionalController;

abstract class _PizOptionalController with Store {
