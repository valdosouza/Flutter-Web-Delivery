...
import 'cal_optional_item.dart';

// ignore: must_be_immutable
class CalOptionalList extends StatelessWidget {
  CalOptionalController store = CalOptionalController();
            ...
            return RefreshIndicator(
              ...
              child: Observer(builder: (_) {
                return ListView.builder(
                    ...
                    itemCount: cal.item.itemsDetail[cal.indexFlavor]
                        .ingredOptional.length,
                    itemBuilder: (context, index) {
                      final post = cal.item.itemsDetail[cal.indexFlavor]
                          .ingredOptional[index];
                      return CalOptionalItem(item: post);
                    });
              }),
            );
            break;
