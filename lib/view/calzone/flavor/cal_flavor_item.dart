...
class CalFlavorItem extends StatelessWidget {
  final MenuModel item;
  const CalFlavorItem({Key key, this.item}) : super(key: key);
  @override
          ...
          children: [
            Expanded(
              ...
              child: (item.linkUrl != null)
                  ...
                  : Image.network(
                      "https://www.gestaowebsetes.com.br/images/appweb/delivery/icon_calzone.jpg"),
            ),
            Expanded(
              flex: 4,
              child: Column(
        ...
        onPressed: () => {
          calMainController.editItemDetail(
            OrderItemsDetailModel(
              id: calMainController.indexFlavor + 1,
              menuId: item.id,
    ...
    return Visibility(
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          onPressed: () => {
            Navigator.pushNamed(context, AppRoutes.PIZFLAVORINGREDIENTMAIN),
          },
        ),
      ),
    );
