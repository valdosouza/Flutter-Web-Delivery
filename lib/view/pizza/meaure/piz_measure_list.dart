...
import 'package:delivery/view/pizza/meaure/piz_measure_item.dart';
...
class PizMeasureList extends StatelessWidget {
  PizMeasureController store = PizMeasureController();
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return PizMeasureItem(item: post);
                },
              ),
            );
            break;
