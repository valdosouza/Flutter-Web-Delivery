...
class PizMeasure extends StatelessWidget {
  @override
          ...
          Expanded(
            ...
            child: Observer(builder: (_) {
              return Container(
                ...
                child: getImage(pizMainController.item.measure),
              );
            }),
          ),
          Expanded(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Observer(builder: (_) {
                  return Text(
                    pizMainController.item.measure,
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: () => {
                  Navigator.pushNamed(context, AppRoutes.PIZMEASUREMAIN),
                },
              ),
            ),
          ),
